---
name: giodb-conventions
description: Use when writing or reviewing C++ code in the GioDB project. Provides coding conventions, error handling patterns, and naming rules.
user-invocable: false
---

# GioDB Coding Conventions
...
- **Namespaces**: All code lives in `giodb::`
...
```cpp
GIODB_LOG_TRACE("detailed: {}", value);
GIODB_LOG_DEBUG("debug info");
GIODB_LOG_INFO("startup");
GIODB_LOG_WARN("warning: {}", reason);
GIODB_LOG_ERROR("error: {}", err.message);
GIODB_LOG_FATAL("unrecoverable");
```
