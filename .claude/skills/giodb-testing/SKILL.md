---
name: giodb-testing
description: Use when writing or reviewing unit tests for the GioDB project. Provides test patterns, fixture conventions, and quality requirements.
...
```cpp
void SetUp() override {
    data_dir_ = std::filesystem::temp_directory_path() / "giodb_test_<name>";
